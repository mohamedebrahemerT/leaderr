                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="paper_size" required id="paper-size">
                                            ...
                                            <option selected value="38">38 mm (1.5 inch)</option>
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div  style="text-align: center;" id="label-content">
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
            ...
            $.each(qty, function(index){
                ...
                while(i < qty[index]) {
                    ...
                    if(paper_size == 18)
                        ...
                        htmltext += '<img style="max-width:80px;height:100%;max-height:30px" src="data:image/png;base64,'+barcode_image[index]+'" alt="barcode" /><br>';
    ...
    $("#print-btn").on("click", function(){
          ...
          newWin.document.write('<style type="text/css">@media  print { #modal_header { display: none } #print-btn { display: none } #close-btn { display: none } } table.barcodelist { page-break-inside:auto } table.barcodelist tr { page-break-inside:avoid; page-break-after:auto }</style><body onload="window.print()" style="width:1.5in ;height: 0.98in;">'+divToPrint.innerHTML+'</body>');
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dashboard\top-gift\resources\views/product/print_barcode.blade.php ENDPATH**/ ?>