      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-12 offset-1" id="product-content" style="font-size: 30px;text-align: center;"></div>
...
<script>
    ...
    function productDetails(product, imagedata) {
        ...
        htmltext = '</p><p><strong><?php echo e(trans("file.name")); ?>: </strong>'+product[1]+'</p><p><strong><?php echo e(trans("file.Code")); ?>: </strong>'+product[2]+'</p><p><strong><?php echo e(trans("file.Price")); ?>: </strong>'+product[7];
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/home/mohamedebrahem/pos.mohamed-ebrahem.com/resources/views/product/index.blade.php ENDPATH**/ ?>